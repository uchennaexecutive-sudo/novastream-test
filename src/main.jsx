  ...
  useEffect(() => {
    ...
    async function checkAndDownload() {
      try {
        ...
        if (!downloadUrl) {
          // No Windows download URL ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â not on a supported update platform, treat as up-to-date
          setUpdateState('up-to-date')
          scheduleCheck(UPDATE_REFRESH_INTERVAL_MS)
          return
        }
